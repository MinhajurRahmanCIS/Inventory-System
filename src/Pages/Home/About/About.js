    ...
    return (
        <div className="hero bg-base-300 mb-10">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className='ml-5'>
                    <h1 className="text-5xl font-bold text-indigo-300">About Use</h1>
                    <p className="py-6">Please tell about our business. We all ways try to improve. Well Will response your any query About use.</p>
